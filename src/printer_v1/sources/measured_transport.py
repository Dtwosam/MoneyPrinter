...
LIFECYCLE_RESERVED_OPERATIONS_BY_STEP_KIND = MappingProxyType(
    {
        ...
        # Lane-2 phase split: each reservation follows the phase that owns the
        # governed operation. Audit owns no provider request.
        "WINDOW_CLOSE_EVIDENCE": 1,
        "WINDOW_CLOSE_PRE_CLOSE_CRITICAL": 1,
        "WINDOW_CLOSE_CONTEXT": 0,
        "WINDOW_CLOSE_AUDIT": 0,
        "CONTINUATION_CLOSE_EVIDENCE": 1,
        "CONTINUATION_CLOSE_PRE_CLOSE_CRITICAL": 1,
        "CONTINUATION_CLOSE_CONTEXT": 0,
        "CONTINUATION_CLOSE_AUDIT": 0,
        "LONG_CONTINUATION_CLOSE_EVIDENCE": 1,
        "LONG_CONTINUATION_CLOSE_PRE_CLOSE_CRITICAL": 1,
        "LONG_CONTINUATION_CLOSE_CONTEXT": 0,
        "LONG_CONTINUATION_CLOSE_AUDIT": 0,
    }
)
