...
class DiscoveryChannelLabel(StrEnum):
    ...
    # PumpSwap read-only confirmation labels — provenance/audit only.
    # Hard eligibility gates apply regardless of channel label.
    PUMPSWAP_POOL_CONFIRMATION = "PUMPSWAP_POOL_CONFIRMATION"
    PUMPSWAP_MIGRATION_POOL_REFERENCE = "PUMPSWAP_MIGRATION_POOL_REFERENCE"
    PUMPSWAP_LIQUIDITY_REFERENCE = "PUMPSWAP_LIQUIDITY_REFERENCE"
