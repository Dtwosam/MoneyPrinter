...
# Migration 062 remains a distinct evidence identity after migration 063
# promotes it to preserved historical schema-transition evidence.
...
# The controlled migration-063 application is the singular current schema
# transition for every four-token authority. Its exact execution and complete
# inventory identity are committed on the profiles below; filesystem discovery
# may only prove equality or fail closed.
MIGRATION_063_PACKAGE_KIND = "MIGRATION_063_EVIDENCE"
MIGRATION_063_PACKAGE_ROOT = (
...
# Migration 062 became preserved historical evidence once Migration 063 took
# over current schema-transition authority. Its historical class deliberately
# produces a different inventory digest from its former current class.
HISTORICAL_MIGRATION_062_EVIDENCE_CLASS = "HISTORICAL_MIGRATION_062_EVIDENCE"
FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXECUTION_ID = "MIGRATION_062_20260828T182504Z"

# Immutable COMPLETE current inventory identity for every four-token profile.
FOUR_TOKEN_CURRENT_MIGRATION_063_EXECUTION_ID = (
    "V2_9_8B_MIGRATION_063_AUTH_20260913T203954Z_5f3a8c1d"
)
FOUR_TOKEN_CURRENT_MIGRATION_063_EXPECTED_FILE_COUNT = 2
FOUR_TOKEN_CURRENT_MIGRATION_063_EXPECTED_INVENTORY_SHA256 = (
...
FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXPECTED_FILE_COUNT = 4
FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXPECTED_INVENTORY_SHA256 = (
...
#
# Migrations 050, 055, 056, 057, 058, 059, 061 and 062 are the declared *required*
...
# back to current authority, which is Migration 063 alone.
#
...
FOUR_TOKEN_HISTORICAL_MIGRATION_PACKAGES: tuple[HistoricalMigrationPackage, ...] = (
    ...
    HistoricalMigrationPackage(
        package_root=MIGRATION_062_PACKAGE_ROOT,
        execution_id=FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXECUTION_ID,
        evidence_class=HISTORICAL_MIGRATION_062_EVIDENCE_CLASS,
        expected_file_count=(
            FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXPECTED_FILE_COUNT
        ),
        expected_inventory_sha256=(
            FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXPECTED_INVENTORY_SHA256
        ),
...
FOUR_TOKEN_PROOF_AUTHORIZATION_PROFILE = GitAuthorizationProfile(
    ...
    current_migration_execution_id=FOUR_TOKEN_CURRENT_MIGRATION_063_EXECUTION_ID,
    current_migration_expected_file_count=(
        FOUR_TOKEN_CURRENT_MIGRATION_063_EXPECTED_FILE_COUNT
    ),
...
_NON_RECONCILIATION_EVIDENCE_CLASSES = frozenset(
    {
        ...
        HISTORICAL_MIGRATION_062_EVIDENCE_CLASS,
...
__all__ = [
    ...
    "FOUR_TOKEN_HISTORICAL_MIGRATION_062_EXECUTION_ID",
