...
FOUR_TOKEN_PROOF_CHILD_TERMINAL_SCHEMA_VERSION = (
    "PRINTER_V1_FOUR_TOKEN_PROOF_CHILD_TERMINAL_V1"
)
FOUR_TOKEN_STANDARD_FOUR_HOUR_CHILD_TERMINAL_SCHEMA_VERSION = (
    "PRINTER_V1_FOUR_TOKEN_STANDARD_FOUR_HOUR_CHILD_TERMINAL_V1"
)
FOUR_TOKEN_ADMISSION_CHECKPOINT_CHILD_TERMINAL_SCHEMA_VERSION = (
    "PRINTER_V1_FOUR_TOKEN_ADMISSION_CHECKPOINT_CHILD_TERMINAL_V1"
)
