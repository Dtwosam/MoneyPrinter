"""Lane X12 — TRACK_NORMAL_1H Runtime Handler Boundary.

Defines the bounded execution handler for TRACK_NORMAL_1H scheduler jobs.
Parallel to lane_e2h_normal_first_15m_handler.py (TRACK_NORMAL_FIRST_15M)
but for the 1h continuation phase of TRACK_NORMAL tokens.

This handler is called by lane_x12_1h_runner when a TRACK_NORMAL token's
...
- Target window: WINDOW_1H (1h continuation memory; 15m handled by X10.10B).
...
Gate order (mirrors lane_e2h_normal_first_15m_handler.py):
...
HANDLER_JOB_KIND: str = "TRACK_NORMAL_1H"
HANDLER_LIFECYCLE_LANE: str = "TRACK_NORMAL"
HANDLER_TARGET_WINDOW: str = "WINDOW_1H"
HANDLER_SOURCE_NAME: str = "dexscreener"
HANDLER_REQUEST_KIND: str = "pair_market_snapshot"

E2H_NORMAL_1H_STATUS_EXECUTED: str = "E2H_NORMAL_TRACK_NORMAL_1H_EXECUTED"
E2H_NORMAL_1H_STATUS_BLOCKED: str = "E2H_NORMAL_TRACK_NORMAL_1H_BLOCKED"
...
def is_handler_registered() -> bool:
    """Return True — TRACK_NORMAL_1H handler is registered in Lane X12."""
    return True
...
def validate_token_entry(entry: dict[str, Any]) -> tuple[bool, str]:
    """Validate a single token entry for TRACK_NORMAL_1H.
...
def execute_track_normal_1h_job(
    connection: sqlite3.Connection,
    ...
    *,
    ...
    """Execute handler for a TRACK_NORMAL_1H scheduler job.
    ...
    if not transport_ok:
        return {
            ...
            "status": E2H_NORMAL_1H_STATUS_BLOCKED,
            "executed": False,
    ...
    return {
        "handler": HANDLER_JOB_KIND,
        "status": E2H_NORMAL_1H_STATUS_EXECUTED,
        "executed": True,
