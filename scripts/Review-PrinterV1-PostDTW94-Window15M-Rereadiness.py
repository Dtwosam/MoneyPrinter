...
BRANCH = "agent/v2-9-8b-post-dtw94-window15m-rereadiness-audit"
HEAD = "62322c253e853ca669e4e5b105b71f301d418431"
...
def main() -> int:
    ...
    try:
        ...
        result = {
            "status": "PASS",
            "verdict": "V2_9_8B_POST_DTW94_WINDOW_15M_REREADINESS_PASS",
            "branch": BRANCH,
            "head": HEAD,
        ...
        print(
            json.dumps(
                {
                    "status": "BLOCKED",
                    "verdict": "V2_9_8B_POST_DTW94_WINDOW_15M_REREADINESS_BLOCKED",
                    "phase": phase,
