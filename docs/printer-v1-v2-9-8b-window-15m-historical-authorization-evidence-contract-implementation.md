...
Readiness lanes must resolve and bind the **live branch tip** after any follow-up repair. Do not hard-code a self-referential final branch SHA inside a commit.
