# Printer V1 V2-9.8B WINDOW_15M Checkpoint 8 — Post-DTW50 Controlling Re-proof Authorization
...
`26a28537d40edda75299936560c9fb878d9fae5f`
...
The operator explicitly authorized exactly one fresh local Checkpoint 8 controlling re-proof after DTW-50.
...
- project Python environment `$HOME/Developer/MoneyPrinter/.venv`;
...
If the attempt blocks or fails, preserve the evidence and stop. A later attempt requires a new audit/readiness decision and a new explicit operator authorization.
