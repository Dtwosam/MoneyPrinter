"""V2-9.7E.6 — decisive live re-proof of the selected Pump-origin architecture.
...
USER_AGENT = "PrinterV1/0.1 (+paper-only V2-9.7E.6 decisive origin re-proof)"
...
PROOF_DB = OPS / "v2_9_7e_6_proof.sqlite3"
RESULT_PATH = OPS / "V2_9_7E_6_FINAL_PROOF_RESULT.json"
...
def main() -> int:
    ...
    if not all(implementation.values()):
        ...
        print("V2_9_7E_6_BLOCKED_IMPLEMENTATION_CHANGED")
        return 3
    ...
    if not health_ok:
        ...
        print("V2_9_7E_6_BLOCKED_RPC_UNREACHABLE")
        return 2
    ...
    if not capture_usable:
        ...
        RESULT_PATH.write_text(json.dumps(payload, indent=2), encoding="utf-8")
        print(json.dumps(payload, indent=2))
        print("V2_9_7E_6_BLOCKED_NO_VIABLE_FREE_PUBLIC_RPC_ARCHITECTURE")
        return 1
    ...
    for observation in observations:
        ...
        later_cycle[observation.mint[:8]] = {
            ...
            "layout_match": bool(found)
            and found["create_layout"] == observation.create_layout,
        }
    ...
    adopted_layout_confirmed = any(
        observation.create_layout == CREATE_LAYOUT_V2 for observation in observations
    )
    passed = (
        owner_error is None
        and persistence_error is None
        and len(distinct_mints) >= REQUIRED_CREATES
        and adopted_layout_confirmed
    ...
    payload = {
        ...
        "linkage": {
            ...
            "create_layouts": sorted({o.create_layout for o in observations}),
            "adopted_layout_confirmed": any(
                o.create_layout == CREATE_LAYOUT_V2 for o in observations
            ),
    ...
    print(json.dumps(payload, indent=2))
    if passed:
        print("V2_9_7E_6_PUMP_ORIGIN_ARCHITECTURE_REPROOF_PASS")
        return 0
    print("V2_9_7E_6_BLOCKED_NO_VIABLE_FREE_PUBLIC_RPC_ARCHITECTURE")
    return 1
