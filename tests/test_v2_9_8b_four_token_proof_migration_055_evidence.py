...
class FourTokenProofMigration055EvidenceTests(unittest.TestCase):
    def test_migration_055_identities_are_distinct_from_migration_050(self) -> None:
        ...
        self.assertEqual(
            profile.migration_package_kind, git_auth.MIGRATION_059_PACKAGE_KIND
        )
        self.assertNotEqual(
            git_auth.MIGRATION_055_PACKAGE_ROOT, git_auth.MIGRATION_059_PACKAGE_ROOT
        )
        self.assertNotEqual(
    ...
    def test_exact_migration_055_package_is_bound_and_accepted(self) -> None:
        ...
        try:
            ...
            migration_files = [
                ...
                if item["package_kind"] == git_auth.MIGRATION_059_PACKAGE_KIND
            ]
