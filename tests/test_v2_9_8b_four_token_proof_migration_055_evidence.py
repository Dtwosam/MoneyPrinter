...
class FourTokenProofMigration055EvidenceTests(unittest.TestCase):
    def test_migration_055_identities_are_distinct_from_migration_050(self) -> None:
        ...
        # Migration 055 kept its own identity when 056, 057, 058, then 059 took
        ...
        self.assertEqual(
            profile.migration_package_kind, git_auth.MIGRATION_061_PACKAGE_KIND
        )
        self.assertNotEqual(
            git_auth.MIGRATION_055_PACKAGE_ROOT, git_auth.MIGRATION_061_PACKAGE_ROOT
        )
        self.assertNotEqual(
    ...
    def test_exact_migration_055_package_is_bound_and_accepted(self) -> None:
        ...
        try:
            ...
            migration_files = [
                ...
                if item["package_kind"] == git_auth.MIGRATION_061_PACKAGE_KIND
            ]
