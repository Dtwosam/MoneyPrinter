...
class DurableSupervisionTests(unittest.TestCase):
    ...
    def test_schema_and_launcher_contracts_are_canonical_and_locked(self) -> None:
        ...
        self.assertIn("printer_v1.operator_cli.proof_supervision heartbeat", launcher)
        self.assertIn("printer_v1.operator_cli.proof_supervision recover", launcher)
        self.assertIn("printer_v1.operator_cli.proof_supervision cancel", launcher)
