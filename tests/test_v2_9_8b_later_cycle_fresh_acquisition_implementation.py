...
def _raw_owner(
    ...
    *,
    rebinder=None,
    acquisition_deadline="2026-08-17T00:40:00+00:00",
    work_deadline="2026-08-17T04:45:00+00:00",
):
...
def test_canonical_builder_rebinds_cycle_scope_but_preserves_campaign_seed(
