...
class WiringTests(e8._IntegrationBase):
    ...
    def _supply(self) -> GraduatedSupply:
        ...
        return GraduatedSupply(
            ...
            candidate_a={"mint": _MINT_LATEST, "pair_address": _POOL_LATEST, "provenance": "LATEST_GRADUATED"},
            candidate_b={"mint": _MINT_PERSISTED, "pair_address": _POOL_PERSISTED, "provenance": "PERSISTED_GRADUATED"},
            two_candidate_selection={
                "ready": True,
                "terminal": "SELECTION_TWO_TOKEN_READY",
                "candidate_a": {"mint": _MINT_LATEST, "pair_address": _POOL_LATEST},
                "candidate_b": {"mint": _MINT_PERSISTED, "pair_address": _POOL_PERSISTED},
                "composition_label": "LATEST+PERSISTED",
            },
