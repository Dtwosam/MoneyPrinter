...
def _prepare(
    ...
    *,
    ...
    if pre_admit_cycle_one:
        ...
        # Admission-integration fixtures need the real Cycle-1 executor to own
        # token/pair/queue/slot creation. Seed only the empty campaign cycle.
        connection.execute(
